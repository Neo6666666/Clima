...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "bf07ce3fe69d38ad50814738923be306";
    ...
    private void getWeatherForNewCity(final String city) {
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                //Log.d("Clima", "onLocationChanged: location has been changed!");
                String longitide = String.valueOf(location.getLongitude());
                String latitude = String.valueOf(location.getLatitude());
                //Log.d("Clima", "onLocationChanged: longitide is " + longitide);
            ...
            public void onProviderDisabled(String provider) {
                Log.d("Clima", "onProviderDisabled: provider disabled.");
            }
        };
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Log.d("Clima", "onRequestPermissionsResult: permissions granted!");
                getWeatherForCurrentLocation();
            }
            else {
                Log.d("Clima", "onRequestPermissionsResult: permissions denied!");
            }
        }
    }
// TODO: Add letsDoSomeNetworking(RequestParams params) here:
    ...
    private void letsDoSomeNetworking(RequestParams params) {
        ...
        Log.d("Clima", "letsDoSomeNetworking: here");
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject response) {
                ...
                Log.d("Clima", "onFailure: " + throwable.toString());
                Toast.makeText(WeatherController.this, "Failed to achive weather", Toast.LENGTH_SHORT).show();
            }
        });
    }
